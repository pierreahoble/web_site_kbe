    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="promo-single-wrap p-5 text-center border rounded">
                    <div class="promo-icon mb-4">
                        <img src="css/img/search-engine.svg" alt="promo" width="65">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="promo-single-wrap p-5 text-center border rounded">
                    <div class="promo-icon mb-4">
                        <img src="css/img/increase.svg" alt="promo" width="65">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="promo-single-wrap p-5 text-center border rounded">
                    <div class="promo-icon mb-4">
                        <img src="css/img/bullhorn.svg" alt="promo" width="65">
        ...
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-md-12 col-lg-6">
                <div class="card border-0 text-white">
                    <img src="css/img/why-choose-us.png" alt="video" class="img-fluid">
                    <div class="card-img-overlay text-center">
                        <a href="https://www.youtube.com/watch?v=9No-FiEInLA"
                            class="popup-youtube video-play-icon color-bip shadow"><span class="ti-control-play"></span>
                        </a>
                    </div>
                </div>
            </div>
