...
<!-- Mirrored from digimark.themetags.com/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Jan 2022 21:05:55 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--ytplayer css-->
    <link rel="stylesheet" href="{{ asset('css/css/jquery.mb.YTPlayer.min.css')}}">
    <!--Owl carousel css-->
        ...
        <div class="container-fluid">
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-12 col-md-7 col-lg-6 col-xl-8 d-none d-lg-block">
                    <!-- Image -->
                    <div class="bg-cover vh-100 ml-n3 gradient-overlay" style="background-image: url({{ asset('css/img/slider-img-5.jpg') }});">
                        <div class="position-absolute login-signup-content">
                            <div class="position-relative text-white col-md-12 col-lg-7">
                                <h2 class="text-white">Content de te revoir !</h2>
                        ...
                        <form class="login-signup-form">
                            ...
                            <p class="text-center">
                                <small class="text-muted text-center">
                                    Vous n'avez pas encore de compte? <a href="{{ url('register') }}">S'inscrire.</a>.
                                </small>
                            </p>
