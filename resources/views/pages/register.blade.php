...
<!-- Mirrored from digimark.themetags.com/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Jan 2022 21:05:55 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--Bootstrap css-->
    <link rel="stylesheet" href="{{ url('css/css/bootstrap.min.css')}}">
    <!--Magnific popup css-->
    <link rel="stylesheet" href="{{ url('css/css/magnific-popup.css')}}">
    <!--Themify icon css-->
    <link rel="stylesheet" href="{{ url('css/css/themify-icons.css')}}">
    <!--Fontawesome icon css-->
    <link rel="stylesheet" href="{{ url('css/css/all.min.css')}}">
    <!--animated css-->
    <link rel="stylesheet" href="{{ url('css/css/animate.min.css')}}">
    <!--ytplayer css-->
    <link rel="stylesheet" href="{{ url('css/css/jquery.mb.YTPlayer.min.css')}}">
    <!--Owl carousel css-->
    <link rel="stylesheet" href="{{ url('css/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{ url('css/css/owl.theme.default.min.css')}}">
    <!--custom css-->
    <link rel="stylesheet" href="{{ url('css/css/style.css')}}">
    <!--responsive css-->
    <link rel="stylesheet" href="{{ url('css/css/responsive.css')}}">
        ...
        <div class="container-fluid">
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-md-7 col-lg-6 col-xl-8 d-none d-lg-block">
                    <!-- Image -->
                    <div class="bg-cover vh-100 ml-n3 gradient-overlay" style="background-image: url({{ url('css/img/slider-img-5.jpg') }});">
                        <div class="position-absolute login-signup-content">
                            <div class="position-relative text-white col-md-12 col-lg-7">
                                <h2 class="text-white">Créez votre compte</h2>
                    ...
                    <div class="login-signup-wrap px-4 px-lg-5">
                        ...
                        <form class="login-signup-form">
                            ...
                            <div class="form-check d-flex align-items-center text-center">
                                ...
                                <label class="form-check-label small" for="exampleCheck1">J'accepte vos  <a href="#">termes et conditions</a></label>
                            </div>
...
<!--jQuery-->
<script src="{{ asset('css/js/jquery-3.5.0.min.js')}}"></script>
<!--Popper js-->
...
<!--jquery easing js-->
<script src="{{ asset('css/js/jquery.easing.min.js')}}"></script>
<!--jquery ytplayer js-->
<script src="{{ asset('css/js/jquery.mb.YTPlayer.min.js')}}"></script>
<!--Isotope filter js-->
...
<!--countdown js-->
<script src="{{ asset('css/js/jquery.countdown.min.js')}}"></script>
<!--jquery easypiechart-->
<script src="{{ asset('css/js/jquery.easy-pie-chart.js')}}"></script>
<!--custom js-->
