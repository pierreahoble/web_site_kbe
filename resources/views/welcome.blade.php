                                    ...
                                    <div class="col-md-6 col-lg-5">
                                        <div class="why-choose-us-wrap">
                                            ...
                                            <ul class="list-with-icon">
                                                ...
                                                <li class="d-flex align-items-start">
                                                    <img src="css/img/search-engine.svg" width="35" class="mr-3" alt="list icon">
                                                    <div class="list-icon-info">
                                                ...
                                                <li class="d-flex align-items-start">
                                                    <img src="css/img/interface.svg" width="35" class="mr-3" alt="list icon">
                                                    <div class="list-icon-info">
                    ...
                    <div class="single-blog-card card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Some quick example text to build on the card title and make up the
                                bulk.<{{ url('detail-service',['id'=>2222245]) }} f="#" class="detail-link">Lire la suite <span class="ti-arrow-right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="single-blog-card card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Synergistically engage effective ROI after customer directed
                                partnerships.<{{ url('detail-service',['id'=>2222245]) }} f="#" class="detail-link">Lire la suite <span class="ti-arrow-right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="single-blog-card card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Holisticly mesh open-source leadership rather than proactive
                                users. <{{ url('detail-service',['id'=>2222245]) }} f="#" class="detail-link">Lire la suite <span class="ti-arrow-right"></span></a>
                        </div>
                    </div>
                </div>
            </div>
