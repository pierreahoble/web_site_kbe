            ...
            <div class="col-md-12 col-lg-5">
                <div class="hero-slider-content text-white pt-5">
                    ...
                    <div class="action-btns mt-3">
                        <a href="#" class="btn secondary-solid-btn">Commencer maintenant</a>
                    </div>
                </div>
            </div>
            <div class="col-md-12 col-lg-7">
                <div class="image-wrap pt-5">
                    <img src="css/img/t1-hero-img.svg" class="img-fluid custom-width" alt="hero" />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6">
                <div class="about-us-img">
                    <img src="css/img/about-us-img.svg" alt="about us" class="img-fluid about-single-img">
                    <img src="css/img/about-us-img-bg.svg" alt="about bg" class="about-us-bg">
                </div>
            </div>
            <div class="col-md-6 col-lg-6">
                <div class="about-us-content-wrap">
                    <strong class="color-secondary">A Propos De Nous </strong>
                    ...
                    <ul class="list-unstyled tech-feature-list">
                        ...
                        <li class="py-1"><span
                                class="ti-control-forward mr-2 color-secondary"></span><strong>Accounting</strong>
                    ...
                    <div class="action-btns mt-4">
                        <a href="#" class="btn secondary-solid-btn mr-3">Commencer Maintenant</a>
                        <a href="#" class="btn secondary-outline-btn">Lire La Suite</a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="call-to-action ptb-70" style="background: url('css/img/cta-bg.jpg')no-repeat center center / cover">
    <div class="container">
    ...
    <div class="cta-image d-none d-lg-block d-md-block">
        <img src="css/img/cta-1-man.svg" width="200" class="img-left" alt="cta">
        <img src="css/img/cta-1-mike.svg" width="200" class="img-right" alt="cta">
    </div>
</section>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="services-single text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
                    ...
                    <p class="mb-0">Progressively empower business "outside the box" thinking with resource-leveling
                        partnerships.</p>
                    <a href="{{ url('detail-service',['id'=>2222245]) }}" class="detail-link mt-4">Lire la suite <span
        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-md-6 col-lg-5">
                <div class="why-choose-us-wrap">
                    <strong class="color-secondary">Pourquoi Nous choisire </strong>
                    ...
                    <div class="skill-content-wrap">
                        <div class="progress-item">
                            <div class="progress-title">
                                <h6>Technical skills<span class="float-right"><span
                                            class="progress-number">80</span>%</span>
                                </h6>
                            </div>
                            <div class="progress">
                        ...
                        <div class="progress-item">
                            <div class="progress-title">
                                <h6>Web Consulting<span class="float-right"><span
            ...
            <div class="col-md-6 col-lg-6">
                <div class="image-wrap">
                    <img src="css/img/why-choose-us.png" alt="why choose us" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-9">
                <div class="section-heading text-center">
                    <strong class="color-secondary">Processus de travail</strong>
    ...
    <div class="row m-0">
        <div class="col-lg-6 col-md-12 p-0">
            <div class="free-trial-image text-center">
                <img src="css/img/cta-2-girl-img.jpg" alt="image" class="img-fluid">
        ...
        <div class="col-lg-6 col-md-12 p-0">
            <div class="free-trial-content text-white">
                ...
                <a href="#" class="btn primary-solid-btn mt-3">Commenncer Maintenant</a>
            </div>
        </div>
    </div>
</section>
                            ...
                            <div class="row justify-content-around">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <div class="img-wrap my-md-3 my-lg-3 my-sm-0">
                                        <img src="css/img/about-1.jpg" alt="about" class="img-fluid rounded shadow-sm">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane mt-5" id="feature-tab-2">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-md-6 col-lg-5">
                                    <div class="why-choose-us-wrap">
                                        <h3>Best Consulting Every For Business</h3>
                                        <p>Globally reinvent cross-unit human capital whereas virtual catalysts for
                                            change. Assertively
                                            network accurate methods of empowerment rather than client-centered
                                            improvements.</p>
                                        <ul class="list-with-icon">
                                            <li class="d-flex align-items-start">
                                                <img src="css/img/increase.svg" width="35" class="mr-3" alt="list icon">
                                                <div class="list-icon-info">
                                                    <strong>Increased Traffic</strong>
                                                    <p>Conveniently provide access to diverse sources vis-a-vis team
                                                        building customer service. </p>
                                                </div>
                                            </li>
                                            <li class="d-flex align-items-start">
                                                <img src="css/img/search-engine.svg" width="35" class="mr-3"
                                                    alt="list icon">
                                                <div class="list-icon-info">
                                            ...
                                            <li class="d-flex align-items-start">
                                                <img src="css/img/interface.svg" width="35" class="mr-3"
                                                    alt="list icon">
                                                <div class="list-icon-info">
                                                    <strong>Page Rankings</strong>
                                                    <p>Quickly fashion high-quality innovation for cutting-edge sources
                                                        assertively reinvent inexpensive. </p>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="image-wrap">
                                        <img src="css/img/t6-hero-img1.svg" alt="why choose us" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane active mt-5" id="feature-tab-3">
                            <div class="row align-items-center">
                                <div class="col-lg-6 col-md-6">
                                    <div class="image-wrap">
                                        <img src="css/img/tab-img.png" alt="email" class="img-fluid m-auto">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                ...
                <div class="portfolio-container" id="MixItUp">
                    <div class="mix portfolio-item branding" data-ref="mixitup-target">
                        <div class="portfolio-wrapper">
                            <a href="project-details.html" target="_blank">
                                ...
                                <img class="img-fluid" src="css/img/portfolios/3.jpg" alt="portfolio" />
                    ...
                    <div class="mix portfolio-item other animation" data-ref="mixitup-target">
                        <div class="portfolio-wrapper">
                            <a href="project-details.html" target="_blank">
                                <div class="content-overlay"></div>
                                <img class="img-fluid" src="css/img/portfolios/2.jpg" alt="portfolio" />
                                <div class="content-details fadeIn-bottom text-white">
                    ...
                    <div class="mix portfolio-item animation" data-ref="mixitup-target">
                        <div class="portfolio-wrapper">
                            <a href="project-details.html" target="_blank">
                                <div class="content-overlay"></div>
                                <img class="img-fluid" src="css/img/portfolios/4.jpg" alt="portfolio" />
                                <div class="content-details fadeIn-bottom text-white">
                    ...
                    <div class="mix portfolio-item branding" data-ref="mixitup-target">
                        <div class="portfolio-wrapper">
                            <a href="project-details.html" target="_blank">
                                <div class="content-overlay"></div>
                                <img class="img-fluid" src="css/img/portfolios/1.jpg" alt="portfolio" />
                                <div class="content-details fadeIn-bottom text-white">
                                    <h5 class="text-white mb-1">Web UI/UX Design</h5>
                                    <p>Web, Design</p>
                                </div>
                    ...
                    <div class="mix portfolio-item animation other" data-ref="mixitup-target">
                        <div class="portfolio-wrapper">
                            <a href="project-details.html" target="_blank">
                                <div class="content-overlay"></div>
                                <img class="img-fluid" src="css/img/portfolios/5.jpg" alt="portfolio" />
                                <div class="content-details fadeIn-bottom text-white">
                    ...
                    <div class="mix portfolio-item branding " data-ref="mixitup-target">
                        <div class="portfolio-wrapper">
                            <a href="project-details.html" target="_blank">
                                <div class="content-overlay"></div>
                                <img class="img-fluid" src="css/img/portfolios/6.jpg" alt="portfolio" />
                                <div class="content-details fadeIn-bottom text-white">
            ...
            <div class="col-lg-4 col-md-4 col-12">
                <div class="card text-center single-pricing-pack">
                    <div class="price-img pt-5">
                        <img src="css/img/priching-img-1.png" alt="price" width="120" class="img-fluid">
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn outline-btn mb-3" target="_blank">Acheter Maintenant</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-12">
                <div class="card popular-price text-center single-pricing-pack">
                    <div class="price-img pt-5">
                        <img src="css/img/priching-img-2.png" alt="price" width="120" class="img-fluid">
                    </div>
                    <div class="card-header py-4 border-0 pricing-header">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn primary-solid-btn mb-3" target="_blank">Acheter Maintenant</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-12">
                <div class="card text-center single-pricing-pack">
                    <div class="price-img pt-5">
                        <img src="css/img/priching-img-3.png" alt="price" width="120" class="img-fluid">
                    </div>
                    <div class="card-header py-4 border-0 pricing-header">
...
<section class="testimonial-section ptb-100"
    style="background: url('css/img/testimonial-bg.png')no-repeat center center / cover">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6 col-lg-5">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="testimonial-content-wrap">
                    <img src="css/img/testimonial-arrow-top.png" class="img-fluid testimonial-tb-shape shape-top"
                    ...
                    <div class="owl-carousel owl-theme client-testimonial-1 custom-dot testimonial-shape">
                            ...
                            <div class="testimonial-quote-wrap">
                                <div class="media author-info mb-3">
                                    <div class="author-img mr-3">
                                        <img src="css/img/client-1.jpg" alt="client" class="img-fluid">
                                    </div>
                        ...
                        <div class="item">
                            <div class="testimonial-quote-wrap">
                                <div class="media author-info mb-3">
                                    <div class="author-img mr-3">
                                        <img src="css/img/client-2.jpg" alt="client" class="img-fluid">
                                    </div>
                                    <div class="media-body text-white">
                        ...
                        <div class="item">
                            <div class="testimonial-quote-wrap">
                                <div class="media author-info mb-3">
                                    <div class="author-img mr-3">
                                        <img src="css/img/client-3.jpg" alt="client" class="img-fluid">
                                    </div>
                                    <div class="media-body text-white">
                        ...
                        <div class="item">
                            <div class="testimonial-quote-wrap">
                                <div class="media author-info mb-3">
                                    <div class="author-img mr-3">
                                        <img src="css/img/client-4.jpg" alt="client" class="img-fluid">
                                    </div>
                                    <div class="media-body text-white">
                                        <h5 class="mb-0 text-white">John Charles</h5>
                                        <span>BizBite</span>
                    ...
                    <img src="css/img/testimonial-arrow-bottom.png" class="img-fluid testimonial-tb-shape shape-bottom"
                        alt="testimonial shape">
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="single-blog-card card border-0 shadow-sm">
                    <div class="blog-img position-relative">
                        <img src="css/img/blog/1.jpg" class="card-img-top" alt="blog">
                        <div class="meta-date">
                            <strong>24</strong>
                            <small>Apr</small>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Some quick example text to build on the card title and make up the
                            bulk.<{{ url('detail-service',['id'=>2222245]) }} f="#" class="detail-link">Lire la suite
            ...
            <div class="col-md-4">
                <div class="single-blog-card card border-0 shadow-sm">
                    <div class="blog-img position-relative">
                        <img src="css/img/blog/2.jpg" class="card-img-top" alt="blog">
                        <div class="meta-date">
                            <strong>24</strong>
                            <small>Apr</small>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Synergistically engage effective ROI after customer directed
                            partnerships.<{{ url('detail-service',['id'=>2222245]) }} f="#" class="detail-link">Lire la
                                suite <span class="ti-arrow-right"></span></a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="single-blog-card card border-0 shadow-sm">
                    <div class="blog-img position-relative">
                        <img src="css/img/blog/3.jpg" class="card-img-top" alt="blog">
                        <div class="meta-date">
                            <strong>24</strong>
                            <small>Apr</small>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Holisticly mesh open-source leadership rather than proactive
                            users. <{{ url('detail-service',['id'=>2222245]) }} f="#" class="detail-link">Lire la suite
                                <span class="ti-arrow-right"></span></a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="overlay d-flex align-items-center justify-content-center">
                        <div class="overlay-inner">
                            ...
                            <p class="teacher-see-profile">
                                <a href="{{ url('detail-equipe',['id'=>234]) }}" class="btn outline-white-btn">Voir Mon Profil</a>
                            </p>
                        </div>
                    </div>
                </div>
